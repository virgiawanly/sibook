<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">SiBook</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            <a href="#" class="menu-link">
                ...
                <div data-i18n="Analytics">Pengadaan</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="#" class="menu-link">
                <i class="menu-icon tf-icons bx bx-podcast"></i>
                <div data-i18n="Analytics">Buku Hilang / Rusak</div>
            </a>
        </li>
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="#" class="menu-link">
                        <div data-i18n="Account">Laporan Buku</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="#" class="menu-link">
                        <div data-i18n="Notifications">Laporan Pinjaman</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="#" class="menu-link">
                        <div data-i18n="Notifications">Laporan Anggota</div>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="menu-item">
            <a href="#" class="menu-link">
                ...
                <div data-i18n="Analytics">Pengaturan Transaksi</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="#" class="menu-link">
